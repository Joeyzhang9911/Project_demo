...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("sdg_targets", "0005_alter_keyword_target"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    (
                        "5.7",
                        "5.7 Universal access to sexual and reproductive care, family planning and education",
                    ),
                    ...
                    (
                        "1.B",
                        "1.B Create Pro-poor and Gender-sensitive policy framewords",
                    ),
